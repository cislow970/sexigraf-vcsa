...
function isVcsaEnabled($inputvcenter) {
    global $crontabPath;
    return (file_exists($crontabPath . "vcsa_" . str_replace(".", "_", $inputvcenter)));
}
...
function enableVcsa($inputvcenter, $commsnmp2, $usersnmp3, $authsnmp3, $privsnmp3, $activeha, $passiveha, $witnessha) { shell_exec("sudo /bin/bash /var/www/scripts/addVcsaCrontab.sh " . $inputvcenter . " " . $commsnmp2 . " " . $usersnmp3 . " " . $authsnmp3 . " "  . $privsnmp3 . " " . $activeha . " " . $passiveha . " " . $witnessha); }
...
function disableVcsa($inputvcenter) { shell_exec("sudo /bin/bash /var/www/scripts/removeVcsaCrontab.sh " . $inputvcenter); }
